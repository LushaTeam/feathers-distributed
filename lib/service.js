  ...
  constructor(options) {
    ...
    this.on('find', (() => {
      var _ref = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.find(Object.assign({ fromRemote: true }, req.params));
    ...
    this.on('get', (() => {
      var _ref2 = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.get(req.id, Object.assign({ fromRemote: true }, req.params));
    ...
    this.on('create', (() => {
      var _ref3 = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.create(req.data, Object.assign({ fromRemote: true }, req.params));
    ...
    this.on('update', (() => {
      var _ref4 = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.update(req.id, req.data, Object.assign({ fromRemote: true }, req.params));
    ...
    this.on('patch', (() => {
      var _ref5 = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.patch(req.id, req.data, Object.assign({ fromRemote: true }, req.params));
    ...
    this.on('remove', (() => {
      var _ref6 = _asyncToGenerator(function* (req) {
        ...
        const result = yield service.remove(req.id, Object.assign({ fromRemote: true }, req.params));
